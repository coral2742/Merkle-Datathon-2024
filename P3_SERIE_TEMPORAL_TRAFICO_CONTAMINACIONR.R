...
air_quality_gijon <- air_quality_gijon[-c(5,6,15)]
...
valores_atipicos_contaminacion <- which(media_coches_dia < 1200)
valores_atipicos_2 <- movility_gijon$date[valores_atipicos_contaminacion]
valores_atipicos_2
